# Generated by Django 3.0.3 on 2020-04-01 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.SlugField(help_text='Уникальная, читаемая ссылка', max_length=60, verbose_name='Уникальная, читаемая ссылка')),
                ('random_order', models.BooleanField(default=False, help_text='Display the questions in a random order or as they are set?', verbose_name='Случайная последовательность')),
                ('max_questions', models.PositiveIntegerField(blank=True, help_text='Number of questions to be answered on each attempt.', null=True, verbose_name='Количество вопросов')),
                ('answers_at_end', models.BooleanField(default=False, help_text='Correct answer is NOT shown after question. Answers displayed at the end.', verbose_name='Показать ответы в конце?')),
                ...
                ('success_text', models.TextField(blank=True, help_text='Displayed if user passes.', verbose_name='Текст при успешном выполнении теста')),
                ('fail_text', models.TextField(blank=True, help_text='Текст при не выполнении теста', verbose_name='Fail Text')),
